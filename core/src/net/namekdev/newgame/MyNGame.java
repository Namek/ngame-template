package net.namekdev.newgame;

import java.util.Stack;

import net.namekdev.newgame.screen.BaseScreen;
import net.namekdev.newgame.screen.GameScreen;
import net.namekdev.newgame.screen.InstructionScreen;
import net.namekdev.newgame.screen.IntroScreen;
...
public class MyNGame extends ApplicationAdapter {
	...
	public void popScreen(net.namekdev.newgame.screen.BaseScreen<?> screen) {
